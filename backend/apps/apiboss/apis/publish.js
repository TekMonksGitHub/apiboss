 ...
 */
 ...
 exports.doService = async req => {
    ...
    else {APIREGISTRY.addAPI(jsonReq.path, jsonReq.apiregentry); LOG.info(`New API published ${jsonReq.path}:${jsonReq.apiregentry}`); return {data:CONSTANTS.TRUE_RESULT};}
}
